              ...
              $bot->sendMessage([
                  ...
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          ...
                          [['text'=>'Aly Almasry','url'=>'T.me/aly_almasry55']],
                      ]
                  ])
              ]);   
          }
...
User - {$user} ",
                  ...
                  'reply_markup'=>json_encode([
					...
					$bot->sendMessage([
							'chat_id'=>$chatId,
							'text'=>"Hi in Aly Almasry Tool To Grab Available Accounts instagram",
							'reply_markup'=>json_encode([
                  'inline_keyboard'=>[
                      [['text'=>'To BuY The Tool','url'=>'t.me/aly_Almasry55']]
                  ]
							])
					]);
				}
